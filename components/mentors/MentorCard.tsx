...
export function MentorCard({ mentor, active, onHover }: MentorCardProps) {
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          "pointer-events-none absolute left-0 right-0 top-0 h-0",
      ...
      {active && (
        <>
          <span className="pointer-events-none absolute inset-0 ring-1 ring-inset ring-imperium-gold/60" />
      ...
      <div className="relative h-[420px] w-full ">
        ...
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.65),transparent_40%,rgba(0,0,0,0.95))]" />
      </div>
